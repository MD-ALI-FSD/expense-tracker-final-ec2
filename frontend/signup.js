...
signup.addEventListener("click", async function (e) {
  ...
  const userDetails = await axios.get("http://43.205.59.61/user/get-user");
  ...
  try{
    if (id === -2) {
      ...
      const response = await axios.post("http://43.205.59.61/user/signup", newUserData)
  ...
  //   axios
  //     .put(`http://43.205.59.61/user/edit-user/${id}`, newUserData)
  //     .then((res) => {
